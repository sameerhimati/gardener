...
/* Marketing landing page served at /. Self-contained, presentational only.
   The app shell lives at /app. Reuses the app palette (moss accent, ink on
   near-white) and Geist type from the root layout. The root <body> is
   overflow-hidden, so this page owns its own scroll container. No backend calls. */
